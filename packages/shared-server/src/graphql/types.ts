...
export type ResolversTypes = ResolversObject<{
  ...
  Comment: ResolverTypeWrapper<Omit<Comment, 'user'> & { user?: Maybe<ResolversTypes['User']> }>;
  CommentSortType: CommentSortType;
  CommentStats: ResolverTypeWrapper<CommentStats>;
  CommentsForTarget: ResolverTypeWrapper<Omit<CommentsForTarget, 'comments'> & { comments: Array<ResolversTypes['Comment']> }>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Comment: Omit<Comment, 'user'> & { user?: Maybe<ResolversParentTypes['User']> };
  CommentStats: CommentStats;
  CommentsForTarget: Omit<CommentsForTarget, 'comments'> & { comments: Array<ResolversParentTypes['Comment']> };
