...
export enum ActionTypes {
  ...
  GET_USER_COMIC_DATA = 'GET_USER_COMIC_DATA',
  SUBSCRIBE_TO_SERIES = 'SUBSCRIBE_TO_SERIES',
  UNSUBSCRIBE_FROM_SERIES = 'UNSUBSCRIBE_FROM_SERIES',
  ENABLE_NOTIFICATIONS_FOR_SERIES = 'ENABLE_NOTIFICATIONS_FOR_SERIES',
  DISABLE_NOTIFICATIONS_FOR_SERIES = 'DISABLE_NOTIFICATIONS_FOR_SERIES',
}
