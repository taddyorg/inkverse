  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 ly_app_floating on md:hidden w-auto">
      <a 
        ...
        className="link flex items-center justify-between bg-white dark:bg-gray-800 rounded-xl shadow-lg text-black dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-lg py-4 px-4 no-underline whitespace-nowrap"
      >
